...
def aif_align_dataset(
    ...
    if dataset_attr.formatting == "alpaca":
        convert_func = partial(aif_convert_alpaca, dataset_attr=dataset_attr, data_args=data_args)
    else:
        convert_func = partial(aif_convert_sharegpt, dataset_attr=dataset_attr, data_args=data_args)
...
def aif_convert_alpaca(
    ...
    if 'dataset_id' in example:
        output["dataset_id"] = example["dataset_id"]
    return output


def aif_convert_sharegpt(
    example: Dict[str, Any],
    dataset_attr: "DatasetAttr",
    data_args: "DataArguments",
) -> Dict[str, Any]:
